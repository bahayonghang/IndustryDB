...
class PyConnection:
    ...
    def insert(
        self, table: str, data: pl.DataFrame | dict[str, list[Any]], **kwargs: Any
    ) -> int:
        """
...
class PyWebClient:
    ...
    ) -> tuple[dict[str, list[Any]], dict[str, list[Any]], list[str], list[str], list[list[str]]]: ...
    ...
    def update_operation_status(self, project_name: str, project_type: str, operation_status: int) -> None: ...
...
class PyTimeSeriesClient:
    ...
    def get_latest_input_data_view(self, table: str, time_length: int, unit: str) -> dict[str, list[Any]]: ...
    ...
    def get_input_data_history(self, name_list: list[str], begin: str, end: str, chunk_size: str | None = ..., use_temp_file: bool = ...) -> dict[str, list[Any]]: ...
    def get_output_data_history(self, name_list: list[str], begin: str, end: str, chunk_size: str | None = ...) -> dict[str, list[Any]]: ...
    def get_latest_input_data_by_column(self, name_list: list[str]) -> dict[str, list[Any]]: ...
    def get_latest_input_data_by_column_time(self, name_list: list[str], hours: int) -> dict[str, list[Any]]: ...
    def get_latest_input_data_by_column_time_hour(self, name_list: list[str], hours: int) -> dict[str, list[Any]]: ...
    def get_latest_input_data_by_column_time_min(self, name_list: list[str], minutes: int) -> dict[str, list[Any]]: ...
    def get_history_data_by_name_list(self, name_list: list[str], begin: str, end: str) -> dict[str, list[Any]]: ...
    ...
    def get_latest_input_data_model_parameter(self, name_list: list[str], filter_length: str, time_length: int) -> dict[str, list[Any]]: ...
    ...
    def query_decision_history_data_by_name(self, name_list: list[str], time_query: int) -> dict[str, list[Any]]: ...
    ...
    def query_decision_history_data_latest_by_name_list(self, name_list: list[str]) -> dict[str, list[Any]]: ...
    def query_tagdatabase_latest(self) -> dict[str, list[Any]]: ...
    def query_tagdatabase_latest_by_name_list(self, name_list: list[str]) -> dict[str, list[Any]]: ...
    def check_decision_table(self) -> None: ...
    def query_decision_solution_rt_by_column(self, column_name_list: list[str], optimization_type: str) -> dict[str, list[Any]]: ...
...
def create_realtime_predict_alter_client(config: PyDatabaseConfig) -> PyRealtimePredictAlterClient: ...
def create_realtime_predict_sequence_client(config: PyDatabaseConfig) -> PyRealtimePredictSequenceClient: ...
